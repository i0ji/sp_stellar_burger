<h1>Stellar Burger Study Project</h1>

Main stack: React, TS, SCSS, Framer-motion, RTK, Jest, Cypress, DND, React Router

Current version: 0.2.\*. Project finished, maintenance only

Yandex UI kit:
https://yandex-practicum.github.io/react-developer-burger-ui-components/docs/<br>
GH page: https://i0ji.github.io/sp_stellar_burger/#/
...
<summary><b>Commit and update hisotory</b></summary>
  ...
  **\_\_\_** **b**:sprint2/step-2/**v**: 0.1.7.1: Fixing type issues; edits based on reviewers' comments; added preloader and
